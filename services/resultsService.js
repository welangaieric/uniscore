...
const getResultByAdm= async(adm)=>{
    const results = await readRecord('result','*',`ResultAdm like'%${adm}%'`);
    console.log('results:', results);
    return results
}
...
module.exports={getAllResults,addResult,updateResult,deleteResult,getResultByAdm,getResultByYear}